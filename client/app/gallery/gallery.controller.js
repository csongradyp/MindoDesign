...
angular.module('mindodesignApp')
  ...
  arrowsOn = function( instance, selector ) {
	...
	var gallery = $('a').imageLightbox({
        onStart:		function(){ arrowsOn( gallery, 'a' );  overlayOn(); closeButtonOn(gallery);},
        onEnd:			function(){ arrowsOff(); activityIndicatorOff(); overlayOff(); closeButtonOff(); },
